...
<head>
    <meta charset="utf-8">
    <title>Srinivasa Digital Prints - Home page</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=3.0, user-scalable=yes" />
    <meta name="description" content="Srinivasa Digital Prints - Prining House, Bangalore">
    <meta name="author" content="Srinivasa Digital Prints">
    <!--Add css lib-->
...
<body>
    ...
    <header>
        ...
        <section id="top-header" class="clearfix">
            <div class="container">
                <div class="row">
                    <div class="top-links col-lg-7 col-md-6 col-sm-6 col-xs-6">
                        <ul>
                            <li class="hidden-xs">
                                <a href="#">
                    ...
                    <div class="top-header-right f-right col-lg-5 col-md-6 col-sm-6 col-xs-6">
                        <div class="w-header-right">

                            <div class="block-currency">
                                <i class="fa fa-phone"></i>
                                <span>+91 8050 588 775</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="home-slidershow">
            <div class="slide-show">
                <div class="vt-slideshow">
                    <ul>
                        <li class="slide1" data-transition="random"><img src="images/slider/bg_slider_1.jpg" alt="" />
                            <div class="tp-caption lfr" data-x="right" data-hoffset="-56" data-y="170" data-start="800" data-speed="2000" data-endspeed="300"><span class="style1"><span class="textcolor">Flyers</span> & Leaflets</span>
                            </div>
                            ...
                            <div class="tp-caption lfr" data-x="right" data-hoffset="-315" data-y="375" data-start="1300" data-speed="2000" data-easing="easeInOutQuint"
                                data-endspeed="300"><a class="btn-sn" href="#">buy now</a></div>
                        </li>
                        <li class="slide2" data-transition="random"><img src="images/slider/bg_slider_2.jpg" alt="" />
                            <div class="tp-caption lfr" data-x="left" data-hoffset="" data-y="170" data-start="800" data-speed="2000" data-endspeed="300"><span class="style1"><span class="textcolor">Flyers</span> & Leaflets</span>
                            </div>
                        ...
                        <li class="slide3" data-transition="random"><img src="images/slider/bg_slider_3.jpg" alt="" />
                            <div class="tp-caption lft" data-x="left" data-hoffset="" data-y="170" data-start="800" data-speed="2000" data-endspeed="300"><span class="style1"><span class="textcolor">Flyers</span> & Leaflets</span>
                            </div>
                            <div class="tp-caption lfb" data-x="left" data-hoffset="" data-y="225" data-start="800" data-speed="2000" data-endspeed="300">
                                <span class="style2">
									Our A5 flyers and leaflets are our bestselling size.<br> 
                            ...
                            <div class="tp-caption lfl" data-x="left" data-hoffset="" data-y="365" data-start="1300" data-speed="2000" data-easing="easeInOutQuint"
                                data-endspeed="300"><a class="btn-sn" href="#">buy now</a></div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 block-trust trust-col-quantity">
                        ...
                        <div class="tr-text">
                            ...
                            <p>Bright inks. Thick Paper. Precise cuts. We believe that quality printing matters. That quality
                                printing matters.</p>
                    ...
                    <ul class="slider-w slider-owl">
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/1.jpg" alt="Grouper Business card">
                                <div class="action">
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/2.jpg" alt="New Brochures">
                                <div class="action">
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/3.jpg" alt="Flyers Two Page">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/4.jpg" alt="Business Card">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/eSliproser-postcard.jpg" alt="eSliproser Postcards">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/holiday-postcard-2.jpg" alt="Holiday Postcard 2">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/postcard-mailing-services.jpg" alt="Postcard Mailing Services">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/holiday-postcard.jpg" alt="Holiday Postcard">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/new-business-card.jpg" alt="New Business Card">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                        ...
                        <li class="pro-item">
                            <div class="product-image-action">
                                <img src="images/product/small/holiday-postcard-3.jpg" alt="Holiday Postcard 3">
                                <div class="action">
                                    <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i> 
									</button>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="col-md-3 col-sm-4">
                                <div class="pro-item visible-xs">
                                    <div class="product-image-action">
                                        <img src="images/product/small/business-card-2.jpg" alt="Business card 2">
                                        <div class="action">
                                            <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
                            ...
                            <div class="col-md-3 visible-md visible-lg">
                                <div class="pro-item">
                                    <div class="product-image-action">
                                        <img src="images/product/small/new-postcard-card.jpg" alt="New Postcard Cards">
                                        <div class="action">
                                            <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
                        ...
                        <div class="tab-pane" id="tab2">
                            ...
                            <div class="col-md-3 visible-md visible-lg">
                                <div class="pro-item">
                                    <div class="product-image-action">
                                        <img src="images/product/small/grouper-business-card.jpg" alt="New Postcard Cards">
                                        <div class="action">
                                            <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
                                ...
                                <div class="pro-item">
                                    <div class="product-image-action">
                                        <img src="images/product/small/flyers-two-page.jpg" alt="Postcard Mailing Services">
                                        <div class="action">
                                            <button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
												<i class="fa fa-shopping-cart"></i> 
											</button>
                ...
                <div class="row">
                    ...
                    <div class="block-capabititie-w">
                        <div class="block-capabititie col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="decs">
                                <p>Mauris sollicitudin dui quisOrci euismod mattis Integer auctor Aenean id turpis eu est iaculis
                                    suscipit.
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="w-block-recent">
                                    ...
                                    <div class="info-recent">
                                        ...
                                        <div class="text-recent">
                                            <p>
                                                Celebrate 2016 in style with our beloved Mini Photo Wall Calendar. Printed on eggshell paper, make your own calendar in minutes
                                                with 12 special photos.
                                            </p>
                                        </div>
                                        <a href="#" class="read-more">read more</a>
                                    </div>
                            ...
                            <div class="wrap-item">
                                <div class="item">
                                    <div class="inner">
                                        ...
                                        <div class="tes-decs">
                                            <p>This PSD is so well organised - the best Ive ever downloaded from here. The ideas
                                                are also really fresh and new - great work. I cant wait to start work with
                                                it!
                                            </p>
                                        </div>
                                    </div>
    ...
    <footer>
        <div class="footer-main">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12 about-us footer-col">
                        <h2>About Us</h2>
                        <div class="footer-content">
                            ...
                            <ul class="info">
                                <li>
                                    ...
                                    <span>#I5, PYR Residency</span>
                                    <span>Yellappa Reddy Layout</span>
                                    <span>Arakere, Bangalore 560076</span>
                                ...
                                <li>
                                    ...
                                    <span><a href="mailto:info.papilioprints@gmail.com" title="send mail to Cmsmart">info.papilioprints@gmail.com</a></span>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-6 col-xs-12 other-info footer-col hidden-sm">
                        <h2>Mission Statement </h2>
                        <div class="footer-content">
                            <p>
                                To be the one stop solution for all printing needs and ensure to provide the best quality products and assure timely delivery
                                at competitive prices, regardless of the quantity.
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="copy-right">Copyright ©
                            ...
                            </script> Srinivasa Digital Print. All Rights Reserved</p>
